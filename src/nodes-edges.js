...
export const initialNodes = [
  {
    id: '1',
    type: 'node',
    data: { label: 'brain', heading: "2 תוכנית", content: "This is text 1",  date:"2018-6-30" },
    position: { x: 0, y: 0 },
  },
  {
    id: '2',
    type: 'node',
    data: { label: 'conclusion', heading: "היסק 3", content: "This is text 2", date:"2023-6-14" },
    position: { x: 0, y: 100 },
  },
  {
    id: '2a',
    type: 'node',
    data: { label: 'question', heading: "שאלה חדשה 3", content: "This is text 2a",  date:"2013-6-23" },
    position: { x: 0, y: 200 },
  },
  {
    id: '2b',
    type: 'node',
    data: { label: 'brain', heading: "תוכנית 3", content: "This is text 2b",  date:"2013-5-23" },
    position: { x: 0, y: 300 },
  },
  {
    id: '2c',
    type: 'node',
    data: { label: 'question', heading: "שאלה חדשה 2", content: "This is text 2c",  date:"2013-6-23" },
    position: { x: 0, y: 400 },
  },
  {
    id: '2d',
    type: 'node',
    data: { label: 'conclusion', heading: "היסק 2", content: "This is text 2d",  date:"2015-8-13" },
    position: { x: 0, y: 500 },
  },
  {
    id: '3',
    type: 'node',
    data: { label: 'conclusion', heading: "היסק 1", content: "This is text 3", date:"2013-6-23"},
    position: { x: 200, y: 100 },
  },
  {
    id: '4',
    type: 'node',
    data: { label: 'question', heading: "שאלה חדשה 1", content: "This is text 4",  date:"2013-7-13" },
    position: { x: 300, y: 100 },
  },
  {
    id: '10',
    type: 'node',
    data: { label: 'template',heading: "תבנית", content: "This is text 7",  date:"2015-4-13" },
