...
export const initialNodes = [
  {
    id: '1',
    type: 'node',
    data: { label: 'brain', heading: "New Node", content: "This is text 1" },
    position: { x: 0, y: 0 },
  },
  {
    id: '2',
    type: 'node',
    data: { label: 'conclusion', heading: "New Node", content: "This is text 2" },
    position: { x: 0, y: 100 },
  },
  {
    id: '2a',
    type: 'node',
    data: { label: 'question', heading: "New Node", content: "This is text 2a" },
    position: { x: 0, y: 200 },
  },
  {
    id: '2b',
    type: 'node',
    data: { label: 'brain', heading: "New Node", content: "This is text 2b" },
    position: { x: 0, y: 300 },
  },
  {
    id: '2c',
    type: 'node',
    data: { label: 'question', heading: "New Node", content: "This is text 2c" },
    position: { x: 0, y: 400 },
  },
  {
    id: '2d',
    type: 'node',
    data: { label: 'conclusion', heading: "New Node", content: "This is text 2d" },
    position: { x: 0, y: 500 },
  },
  {
    id: '3',
    type: 'node',
    data: { label: 'conclusion', heading: "New Node", content: "This is text 3" },
    position: { x: 200, y: 100 },
  },
  {
    id: '4',
    type: 'node',
    data: { label: 'question', heading: "New Node", content: "This is text 4" },
    position: { x: 300, y: 100 },
  },
  {
    id: '10',
    type: 'node',
    data: { label: 'template',heading: "New Node", content: "This is text 7" },
